...
- Support for Darkpay testnet wallets
...
Information about backup and recovery procedures is available at: https://github.com/DarkPayCoin/copay/blob/master/backupRecovery.md
...
Copay depends on [Bitcore Wallet Service](https://github.com/DarkPayCoin/bitcore-wallet-service) (BWS) for blockchain information, networking and Copayer synchronization. A BWS instance can be setup and operational within minutes or you can use a public instance like `https://bws.darkpay.io`. Switching between BWS instances is very simple and can be done with a click from within Copay. BWS also allows Copay to interoperate with other wallets like [Bitcore Wallet CLI](https://github.com/DarkPayCoin/bitcore-wallet).
...
Copay is released under the MIT License. Please refer to the [LICENSE](https://github.com/DarkPayCoin/copay/blob/master/LICENSE) file that accompanies this project for more information including complete terms and conditions.
