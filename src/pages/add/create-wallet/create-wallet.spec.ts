  ...
  describe('setOptsAndCreate function', () => {
    it('should call create function with options', () => {
      ...
      const opts = {
        ...
        myName: 'test',
        networkName: 'livenet',
        bwsurl: 'https://bws.darkpay.market/bws/api',
        singleAddress: false,
        coin: 'btc',
      ...
      instance.createForm.value.derivationPath = "m/44'/44'/0'";
      instance.createForm.value.bwsURL = 'https://bws.darkpay.market/bws/api';
